...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Tab("Generation", id="txt2img_generation") as txt2img_generation_tab, ResizeHandleRow(equal_height=True):
            with ExitStack() as stack:
                ...
                with gr.Column(elem_id="txt2img_setting_scroll"):
    ...
    with gr.Blocks(analytics_enabled=False) as img2img_interface:
        ...
        with gr.Tab("Generation", id="img2img_generation") as img2img_generation_tab, ResizeHandleRow(equal_height=True):
            with ExitStack() as stack:
                ...
                with gr.Column(elem_id="img2img_setting_scroll"):
    ...
    with gr.Blocks(analytics_enabled=False) as pnginfo_interface:
        with gr.Column(elem_id="pnginfo_setting_scroll"):
    ...
    with gr.Blocks(analytics_enabled=False) as train_interface:
        ...
        with ResizeHandleRow(variant="compact", equal_height=False):
            with gr.Column(elem_id=f"train_scrolls"):
